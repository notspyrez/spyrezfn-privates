...
This repo includes the backend code for SpyrezFN, with accounts, parties, XMPP, and more. 

NOTE: We'd appreciate if you didn't rehost SpyrezFN, using it in a localhost environment is fine, and credit would be appreciated, thanks!
